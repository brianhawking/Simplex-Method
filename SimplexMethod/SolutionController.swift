...
//  SimplexMethod
//
//  Created by Brian Veitch on 1/22/20.
...
class SolutionController: UIViewController {
    ...
    var errorMessage: String = "There is an error, indicating no optimal solution.  Go throught method using Hints to find out what happened."
