...
class KeypadButton : UIButton {
   ...
   required init?(coder aDecoder: NSCoder) {
    ...
    func setup() {
        ...
        // colors
        self.backgroundColor = colors.UIColorFromHex(rgbValue: colors.button1, alpha: 1)
        self.setTitleColor(colors.UIColorFromHex(rgbValue: colors.button1Text, alpha: 1), for: .normal)
